        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'activity-types', component: ActivityTypesComponent, data: { permission: 'Pages.ActivityTypes' }, canActivate: [AppRouteGuard] },
                    // tslint:disable-next-line:max-line-length
                    { path: 'receipt-types', component: ReceiptTypesComponent, data: { permission: 'Pages.ReceiptTypes' }, canActivate: [AppRouteGuard] },
